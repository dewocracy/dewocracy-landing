    ...
    <Layout>
      ...
      <div className="w-full bg-fixed min-h-screen bg-darkBlue py-16">
        <section className="rounded shadow-xl bg-white container mx-auto px-8 py-12 legal">
          ...
          <p>
            El presente documento incluye las condiciones de uso (<span className="font-bold">“Condiciones
            de Uso”</span>) del sitio web www.dewocracy.com (<span className="font-bold">“Sitio Web”</span>) y de la
              plataforma (<span className="font-bold">“Plataforma”</span>) titularidad de DEWOCRACY LABS,
                S.L.(<span className="font-bold">“Dewocracy”</span> o <span className="font-bold">“Nosotros”</span>).
          </p>
          <p>
            ...
            Dewocracy (<span className="font-bold">“Servicios”</span>) a través del Sitio Web y de la Plataforma.
            Al contratar los Servicios de Dewocracy, aceptas las presentes
            Condiciones de Uso, el <Link to="/legal-notice">Aviso Legal</Link>,
            la <Link to="/privacy-policy">Política de Privacidad</Link> y la
            Política de Cookies (<span className="font-bold">“Textos Legales”</span>). En caso de no ser así,
            deberás cesar el uso del Sitio Web y de la Plataforma
            inmediatamente.
          </p>
          ...
          <p>
            ...
            con Stripe, deberás aportar el número de tarjeta, la fecha de
            caducidad, y un Código de Validación que coincide con las tres
            últimas cifras del número impreso en cursiva en el reverso de su
            tarjeta, ofreciendo, de esta forma, más garantías acerca de la
            seguridad de la transacción. Los datos de tu tarjeta de crédito o
            débito que proporciones a la hora de realizar el pago serán
            directamente introducidos en nuestro proveedor de la pasarela de
            pago, Stripe y, por lo tanto, en ningún caso serán introducidos ni
            registrados en ningún servidor de Dewocracy, y serán tratados según
            las condiciones legales de Stripe disponibles en
          ...
          <p>
            ...
            servidor basado en la tecnología de seguridad estándar SSL (Secure
            Sockets Layer). Toda la información que transmitas viajará cifrada a
            través de la red.Una vez realizado el pago de los Servicios, podrás
          ...
          <p>
            ...
            administradores ilimitados, deberás hacer clic en “Mejora tu Plan”
            en el panel de configuración de la Plataforma y se procederá a
            facturar el precio del nuevo Plan seleccionado al mes siguiente de
            la notificación. Si los precios tienen períodos de facturación
            diferentes, el nuevo precio se facturará en el nuevo intervalo, a
            partir del día del cambio del Plan.
          </p>
          ...
          <p>
            ...
            enviándonos un correo electrónico a xxx@dewocracy.com, y nos
          ...
          <p>
            ...
            dirección xxxx@dewocracy.com con la solicitud “baja de
